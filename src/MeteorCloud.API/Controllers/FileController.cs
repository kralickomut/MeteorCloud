...
public class FileController : ControllerBase
{
    ...
    public async Task<IActionResult> Upload([FromForm] IFormFile file, string workspaceId, CancellationToken cancellationToken)
    {
        ...
        var url = MicroserviceEndpoints.FileService + "/api/file/upload/" + workspaceId;
